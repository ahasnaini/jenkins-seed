...
job('GoKubeDemo/Deploy') {
    ...
    steps {
        ...
        shell('export PATH=$PATH:/var/jenkins_home/ && kubectl --context=prod.kubernetes.asadali.net set image deployment/demoappdeployment demoapp=asadali/gokubedemo:$IMAGE_TO_DEPLOY')
    }
}
